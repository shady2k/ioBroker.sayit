...
function Speech2Device(adapter, libs, options) {
    ...
    function sayItBrowser(error, text, device, language, volume, duration, callback) {
        if (error) {
    ...
    function sayItSonos(error, text, device, language, volume, duration, callback) {
        if (error) {
            callback && callback(error, 0);
            return;
        }
    ...
    function sayItMpd(error, text, device, language, volume, duration, callback) {
        if (error) {
            callback && callback(error, 0);
            return;
        }
    ...
    function sayItChromecast(error, text, device, language, volume, duration, callback) {
        if (error) {
            callback && callback(error, 0);
            return;
        }
        ...
        uploadToStates(text, err => {
            ...
            if (volume === 'null') volume = 0;
			if (device === 'null' || device == '') device = adapter.config.cDevice;
            ...
            if (device && options.webLink) {
                const chromecastAnouncementDev = device + '.player.announcement';
    ...
    function sayItGoogleHome(error, text, device, language, volume, duration, callback) {
        if (error) {
            callback && callback(error, 0);
            return;
        }
    ...
    function sayItMP24(error, text, device, language, volume, duration, callback) {
        if (error) {
            callback && callback(error, 0);
            return;
        }
    ...
    function sayItMP24ftp(error, text, device, language, volume, duration, callback) {
        if (error) {
            callback && callback(error, 0);
            return;
        }
    ...
    function sayItSystem(error, text, device, language, volume, duration, callback) {
        if (error) {
            callback && callback(error, 0);
            return;
        }
    ...
    function sayItWindows(error, text, device, language, volume, duration, callback) {
        if (error) {
            callback && callback(error, 0);
            return;
        }
